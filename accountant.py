...
log_moments = [(1,compute_log_moment(q = 0.1, sigma = 5, steps = 10, lmbd = 1)),
(2,compute_log_moment(q = 0.1, sigma = 5, steps = 10, lmbd = 2))]
print(get_privacy_spent(log_moments, 1, None))